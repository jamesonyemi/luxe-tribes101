                ...
                <div class="row">
                                    ...
                                    <form action="{{ route('user.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control " id="user-name" name="username"
                                                ...
                                                data-toggle="tooltip" data-placement="left" placeholder="user name"
                                                required />
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12 p-0">
                        ...
                        <div class="front-img position-absolute">
                            <img src="{{ asset('luxetribe-assets/images/background/back-8.jpg') }}" width="400" />
                        </div>
                        <div class="back-img position-absolute">
                            <img src="{{ asset('luxetribe-assets/images/background/back-7.png') }}" alt="" />
                        </div>
                        <div class="back-img position-absolute">
                            <img src="{{ asset('luxetribe-assets/images/background/back-6.jpg') }}" width="180" />
                        </div>
                    </div>
                </div>
            </div>
